...
class PDF extends FPDF
{
    ...
    function Body()
    {
        ...
        //FONDO  
        $this->Image('img/odp_yagua.png', 0, 0, 210, 297);
...
if (isset($_GET['orden_pago'])) {
    ...
    $nombreArchivo = "Orden de Pago - N"; //. utf8_decode($_GET['numero']) . " - " . utf8_decode($_GET['establecimiento']) . ".pdf"; //date("d_m_Y_H_i_s")
